<%-- 
    Document   : searchfood
    Created on : 18 Apr, 2017, 12:20:48 AM
    Author     : hp
--%>
...
<body>
    <h1 class="header" style="margin-top:0 "><font face="Comic Sans MS" color="#336eff">Search Food</font></p></h1>
<div class="location">
<center>
    <form action="ShowFoodDetails1" method="post">
<table >
<tr>
<td><select name="h">
