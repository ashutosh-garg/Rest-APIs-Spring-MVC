...
<body>
    <h1 class="header" style="margin-top:0 "><font face="Comic Sans MS" color="#336eff">Add Rental Rooms</font></p></h1>
<div class="location">
    <center>
    <form action="MakeEntry" method="post" onSubmit="valid()">
<table >
<tr>
			<td>ADD an image :</td>
			<td>
			<input type='file' name="imageurl" onchange="readURL(this);" /></td>
				<td>
					<img id="blah" width="200px" height="150px" src="15.jpg" alt="your image">
                        ...
                        <tr><td>Enter Monthly Rent Price :</td><td><input name="price" type="text" id="price" onfocusout="validateRent()" onclick="changeimg();" placeholder="Rent Price " required /></td><td><font color="red"><p id="ren"></p></font></td></tr>
				...
				<option value="Malwa_Mill_Region" >Malwa_Mill_Region</option>
                        ...
                        <tr><td>Enter Room Address</td><td><textarea name="address" id="add" onfocusout="validateAdd()" placeholder="Enter an address" required ></textarea></td><td><font color="red"><p id="ad"></p></font></td>
			</tr>
                        <tr><td></td>
